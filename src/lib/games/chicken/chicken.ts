/** Tab class for an unselected chicken step tab in ResultTabs. */
export function getChickenTabClass(): string {
  return (
...
/** Tab class for the selected chicken step tab in ResultTabs. */
export function getChickenTabSelectedClass(): string {
  return (
